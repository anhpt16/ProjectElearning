package com.study.centerlearning.admin.test;
...
public class CenterlearningAdminPluginStartupTest {

    public static void main(String[] args) throws Exception {
        EzyHttpApplicationBootstrap.start(CenterlearningAdminPluginStartupTest.class);
    }
}
